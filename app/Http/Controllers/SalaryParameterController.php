...
use App\Http\Requests\SalaryParameterRequest;
...
class SalaryParameterController extends Controller
{
     ...
     */
    public function store(SalaryParameterRequest $request)
    {
    ...
    {
        return $this->successResponse(SalaryParameter::findOrFail($id));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(SalaryParameterRequest $request, $id)
    {
    ...
    {
        $data = SalaryParameter::findOrFail($id);
    ...
    public function getData($request)
    {
        ...
        $data = SalaryParameter::where('tenant_id', $request->tenant_id);
