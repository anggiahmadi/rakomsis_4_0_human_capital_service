...
class WorkingTimeController extends Controller
{
    ...
    {
        return $this->successResponse(WorkingTime::findOrFail($id));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(WorkingTimeRequest $request, $id)
    {
    ...
    public function destroy(Request $request, $id)
    {
        if ($request->is_permanent_delete) {
            ...
            $data = WorkingTime::withTrashed()->findOrFail($id);

            $data->forceDelete();

            DB::commit();
        } else {
            $data = WorkingTime::findOrFail($id);
    ...
    public function getData($request)
    {
        ...
        $data = WorkingTime::where('tenant_id', $request->tenant_id);
